        ...
        <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
          ...
          <tr>
            <td style="padding: 30px 30px 20px">
              ...
              <p style="margin-bottom: 10px;">Your customer information was successfully updated on the Fiber Portal.</p>
              <p style="margin-bottom: 10px;">Please ensure the following information below is accurate for our records:</p>
