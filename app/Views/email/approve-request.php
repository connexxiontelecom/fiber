        ...
        <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
          ...
          <tr>
            <td style="padding: 30px 30px 20px">
              ...
              <p style="margin-bottom: 10px;">The following request has been approved on the Fiber Portal. Our team is fulfilling your request and you should be notified of success shortly: </p>
