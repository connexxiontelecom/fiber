        ...
        <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
          ...
          <tr>
            <td style="padding: 30px 30px 20px">
              ...
              <p style="margin-bottom: 10px;">The following subscription on the Fiber Portal is close to expiring. You can send a request for an extension in the portal: </p>
