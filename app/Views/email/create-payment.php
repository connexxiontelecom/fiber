        ...
        <table style="width:100%;max-width:620px;margin:0 auto;background-color:#ffffff;">
          ...
          <tr>
            <td style="padding: 30px 30px 20px">
              ...
              <p style="margin-bottom: 10px;">The payment you made has been received on the Fiber Portal. Please view and print all relevant invoices/receipts in the portal: </p>
              <p style="margin-bottom: 10px">
                Invoice Ref: <?=$invoice?> <br>
                Receipt Ref: <?=$receipt?> <br>
                Date: <?=$date?> <br>
                Amount: <?=$amount?>
              </p>
