                  ...
                  <div class="nk-block-between-md g-4">
                    <div class="nk-block-head-content">
                      ...
                      <div class="nk-block-des">
                        <p>Here is a list of packages that you are subscribed to.
                      </div>
                    </div>
                    <div class="nk-block-head-content">
                        ...
                        <div class="col-md-8">
                          ...
                          <div class="sp-plan-desc card-inner">
                            <ul class="row gx-1">
                              ...
                              <li class="col-6 col-lg-4">
                                <p>
                                  <span class="text-soft">IPv4 Address</span>
                    ...
                    <div class="card-inner card-inner-lg">
                      <div class="nk-help">
                        ...
                        <div class="nk-help-text">
                          ...
                          <p class="text-soft">File a support ticket to report any issues. Our support team will get back to you as soon as possible.</p>
                        </div>
